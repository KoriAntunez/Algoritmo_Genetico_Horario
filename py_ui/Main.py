...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Asignación de Horarios"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Instructores"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Aulas"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSubjects), _translate("MainWindow", "Asignaturas"))
        self.groupBox_4.setTitle(_translate("MainWindow", "Operation"))
        self.btnSecAdd.setText(_translate("MainWindow", "Añadir Sección"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabSections), _translate("MainWindow", "Secciones"))
        self.groupBox_5.setTitle(_translate("MainWindow", "Operation"))
        self.btnScenGenerate.setText(_translate("MainWindow", "Generar"))
        self.btnScenResult.setText(_translate("MainWindow", "Ver Resultados"))
        self.groupBox_6.setTitle(_translate("MainWindow", "Ajustes de Funcionamiento"))
        self.radioLunchYes.setText(_translate("MainWindow", "Si"))
        ...
        self.label_6.setText(_translate("MainWindow", "Refrigerio"))
        self.label_4.setToolTip(_translate("MainWindow", "Ajustes de Funcionamiento"))
        self.label_4.setText(_translate("MainWindow", "Hora de Inicio"))
        ...
        self.label_11.setText(_translate("MainWindow", "Disparador de ajuste de tasa de mutación"))
        self.label_10.setToolTip(_translate("MainWindow", "Maximum attempts for creating a valid chromosome."))
        self.label_10.setText(_translate("MainWindow", "Máximo de intentos de creación"))
        self.label_9.setToolTip(
            _translate("MainWindow", "Maximum amount of generations to be performed on solution generation."))
        self.label_9.setText(_translate("MainWindow", "Máxima Generación"))
        self.label_7.setToolTip(
            _translate("MainWindow", "Starting point and lowest population count of the genetic algorithm."))
        self.label_7.setText(_translate("MainWindow", "Recuento mínimo de población"))
        self.label_8.setToolTip(_translate("MainWindow", "Highest population count of the genetic algorithm."))
        self.label_8.setText(_translate("MainWindow", "Recuento máximo de población"))
        self.groupBox_9.setTitle(_translate("MainWindow", "Matriz de Evaluación"))
        ...
        self.actionGenerate.setText(_translate("MainWindow", "Generar"))
        self.actionImport_2.setText(_translate("MainWindow", "Importar"))
        self.actionExport_2.setText(_translate("MainWindow", "Exportar"))
