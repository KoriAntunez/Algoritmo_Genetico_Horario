...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Programa de Algoritmo Genético"))
        self.tabInstructors.setWhatsThis(_translate("MainWindow", "<html><head/><body><p><br/></p></body></html>"))
        self.groupBox.setTitle(_translate("MainWindow", "Operación"))
        self.btnInstrAdd.setText(_translate("MainWindow", "Agregar Profesor"))
        self.btnInstrImport.setText(_translate("MainWindow", "Importar formulario CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabInstructors), _translate("MainWindow", "Profesores"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Operación"))
        self.btnRoomAdd.setText(_translate("MainWindow", "Add Room"))
        self.btnRoomImport.setText(_translate("MainWindow", "Import from CSV"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabRooms), _translate("MainWindow", "Salones"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabScenario),
                                  _translate("MainWindow", "Gestión de Escenarios"))
