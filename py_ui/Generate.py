...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Generar"))
        self.groupBox_3.setTitle(_translate("Dialog", "Vista Previa"))
        ...
        self.chkPreview.setText(_translate("Dialog", "Deshabilitar vista previa"))
        self.groupBox_4.setTitle(_translate("Dialog", "Operación"))
        self.btnPause.setText(_translate("Dialog", "Pausar Generación"))
        self.btnStop.setText(_translate("Dialog", "Detener Generation"))
        self.boxGen.setTitle(_translate("Dialog", "Generación N"))
        self.lblFitness.setText(_translate("Dialog", "Promedio de Fitness:"))
        self.lblPreviousFitness.setText(_translate("Dialog", "Previous Average Fitness:"))
        self.lblPopulation.setText(_translate("Dialog", "Población:"))
        self.lblMutation.setText(_translate("Dialog", "Tasa de mutación:"))
        self.lblHighestFitness.setText(_translate("Dialog", "Fitness más bajo:"))
        self.lblLowestFitness.setText(_translate("Dialog", "Fitness más alto:"))
        ...
        self.lblStatus.setText(_translate("Dialog", "Estado:"))
